...
export type MobilePaymentInput = z.infer<typeof createMobilePaymentSchema>;
export type MobilePayment = MobilePaymentInput & {
  user_id: string;
  id: string;
...
export type ExpenseProxy = Pick<MobilePayment, "amount"> & {
  id: number;
};
